...
function wardrobesUpdate() {
	...
	if (V.wardrobes === undefined) {
		...
		/* beach */
		V.wardrobes.changingRoom.name = "沙滩更衣室";
		V.wardrobes.changingRoom.unlocked = true;
		/* eden's */
		V.wardrobes.edensCabin.name = "伊甸的小屋";
		...
		/* school pool girls */
		V.wardrobes.schoolGirls.name = "学校女更衣室";
