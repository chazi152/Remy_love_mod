...
function getFilterRevealOptions(type) {
	const optionsFrom = { "朴素": 0, "时髦": 100, "有品位": 200, "令人舒适": 300, "诱人": 500, "有伤风化": 700, "色情": 900 };
	const optionsTo = { "朴素": 100, "时髦": 200, "有品位": 300, "令人舒适": 500, "诱人": 700, "有伤风化": 900, "色情": 9999 };
...
function shopSearchReplacer(name) {
	return name.replace(/[^a-zA-Z\u4e00-\u9fa50-9' -]+/g, "");
}
